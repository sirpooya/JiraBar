...
///
/// Minimal generic form of osx-autoconnect/Sources/AutoConnectCore/Storage/KeychainStore.swift,
/// the tested one (osx-autoconnect/Tests/AutoConnectCoreTests/KeychainStoreTests.swift). The
/// account metadata layer (JSON in `kSecAttrComment`, sort order) is removed. The query shapes,
/// the error mapping and the tolerances are unchanged.
///
/// Rules carried over:
...
public struct KeychainStore {
    ...
    /// The service every item is filed under, for example "in.pooya.appname.secrets".
